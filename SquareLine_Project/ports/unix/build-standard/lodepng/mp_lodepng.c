 ...
 *
 * Command line:
 * ../../lib/lv_bindings/gen/gen_mpy.py -M lodepng -E build-standard/lodepng/lodepng.pp.c ../../lib/lv_bindings/driver/png/lodepng/lodepng.h
 *
...
STATIC inline void* mp_write_ptr_LodePNGDecompressSettings(mp_obj_t self_in)
{
...
#define mp_write_LodePNGDecompressSettings(struct_obj) *((struct LodePNGDecompressSettings*)mp_write_ptr_LodePNGDecompressSettings(struct_obj))
...
STATIC inline void* mp_write_ptr_LodePNGColorMode(mp_obj_t self_in)
{
    mp_lv_struct_t *self = MP_OBJ_TO_PTR(cast(self_in, get_mp_LodePNGColorMode_type()));
    return (LodePNGColorMode*)self->data;
}

#define mp_write_LodePNGColorMode(struct_obj) *((LodePNGColorMode*)mp_write_ptr_LodePNGColorMode(struct_obj))
...
STATIC inline void* mp_write_ptr_LodePNGTime(mp_obj_t self_in)
{
    mp_lv_struct_t *self = MP_OBJ_TO_PTR(cast(self_in, get_mp_LodePNGTime_type()));
    return (LodePNGTime*)self->data;
}

#define mp_write_LodePNGTime(struct_obj) *((LodePNGTime*)mp_write_ptr_LodePNGTime(struct_obj))
...
STATIC inline void* mp_write_ptr_LodePNGInfo(mp_obj_t self_in)
{
    mp_lv_struct_t *self = MP_OBJ_TO_PTR(cast(self_in, get_mp_LodePNGInfo_type()));
    return (LodePNGInfo*)self->data;
}

#define mp_write_LodePNGInfo(struct_obj) *((LodePNGInfo*)mp_write_ptr_LodePNGInfo(struct_obj))
...
STATIC inline void* mp_write_ptr_LodePNGDecoderSettings(mp_obj_t self_in)
{
    mp_lv_struct_t *self = MP_OBJ_TO_PTR(cast(self_in, get_mp_LodePNGDecoderSettings_type()));
    return (LodePNGDecoderSettings*)self->data;
}

#define mp_write_LodePNGDecoderSettings(struct_obj) *((LodePNGDecoderSettings*)mp_write_ptr_LodePNGDecoderSettings(struct_obj))
...
STATIC inline void* mp_write_ptr_LodePNGState(mp_obj_t self_in)
{
    mp_lv_struct_t *self = MP_OBJ_TO_PTR(cast(self_in, get_mp_LodePNGState_type()));
    return (LodePNGState*)self->data;
}

#define mp_write_LodePNGState(struct_obj) *((LodePNGState*)mp_write_ptr_LodePNGState(struct_obj))
